...
unset($__errorArgs, $__bag); ?>
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      ...
      <div class="form-check form-check-inline <?php $__errorArgs = ['jk'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
        <input class="form-check-input" type="radio" name="jk" 
               value="<?php echo e($k); ?>" <?php if(old('jk') == $k): ?> checked <?php endif; ?>/>
...
unset($__errorArgs, $__bag); ?>
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <input name="tanggal" type="date" class="form-control <?php $__errorArgs = ['tanggal'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <select name="divisi" class="custom-select <?php $__errorArgs = ['jabatan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
        ...
        <option value="<?php echo e($div['id']); ?>" <?php if(old('divisi') == $div['id']): ?> selected <?php endif; ?>> <?php echo e($div['nama']); ?> </option>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </select>
...
unset($__errorArgs, $__bag); ?>
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="hp" name="hp" value="<?php echo e(old('hp')); ?>" type="text" class="form-control <?php $__errorArgs = ['hp'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\Ta\pegawai\resources\views/pegawai/form.blade.php ENDPATH**/ ?>