...
unset($__errorArgs, $__bag); ?>" placeholder="Your Email" name="email" value="<?php echo e(old('email')); ?>" required autocomplete="email" autofocus>
...
<button type="submit" class="input-button"><?php echo e(__('Login')); ?></button>
...
<img src="<?php echo e(asset('assets/img/logo kepegawaian.png')); ?>">
</div>
...
</body></html><?php /**PATH C:\xampp2\htdocs\Ta\pegawai\resources\views/auth/login.blade.php ENDPATH**/ ?>